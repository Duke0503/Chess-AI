...
class Chess:
    ...
    def playHard(self):
        ...
        while not self.gameOver:
            ...
            pygame.display.set_caption("Chess : Play Hard " + str(int(self.GetFrameRate())))
            self.display()
            self.ComputerAI = Minimax(3, self.board, True, True)
    ...
    def playMedium(self):
        ...
        while not self.gameOver:
            ...
            self.getMousePosition()
            # update window caption
            pygame.display.set_caption("Chess : Play Medium " + str(int(self.GetFrameRate())))
            self.display()
            self.ComputerAI = Minimax(2, self.board, True, True)
            self.ComputerMoves(1)
            if self.gameOver == False:
                if self.animateSpot >= Config.spotSize:
                    self.HandleEvents()
    ...
    def playEasy(self):
        ...
        while not self.gameOver:
            ...
            self.getMousePosition()
            # update window caption
            pygame.display.set_caption("Chess : Play Easy " + str(int(self.GetFrameRate())))
            self.display()
            self.ComputerAI = Minimax(1, self.board, True, True)
            self.ComputerMoves(1)
            if self.gameOver == False:
                if self.animateSpot >= Config.spotSize:
                    self.HandleEvents()
